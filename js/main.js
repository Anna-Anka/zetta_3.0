...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (inputs.length) {
    var im = new _node_modules_inputmask_dist_inputmask_es6_js__WEBPACK_IMPORTED_MODULE_0__["default"]('+7 (999) 999-99-99');
    im.mask(inputs);
  }
});
...
new graph_modal__WEBPACK_IMPORTED_MODULE_0__["default"]('consultation');
...
if (document.querySelector('[data-tabs="addresses-block"]')) {
  new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('addresses-block');
}
if (document.querySelector('[data-tabs="completed-projects-block"]')) {
  new graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('completed-projects-block');
}
var GraphTabsWithPagination = /*#__PURE__*/function (_GraphTabs) {
  function GraphTabsWithPagination(selector, options) {
    var _this;
    _classCallCheck(this, GraphTabsWithPagination);
    _this = _callSuper(this, GraphTabsWithPagination, [selector, options]);
    _this.currentIndex = 0;
    _this.totalTabs = _this.tabsBtns.length;
    return _this;
  }
  _inherits(GraphTabsWithPagination, _GraphTabs);
  return _createClass(GraphTabsWithPagination, [{
    key: "init",
    value: function init() {
      _superPropGet(GraphTabsWithPagination, "init", this, 3)([]);
      ...
      this.wrappersPoints.forEach(function (wrapper) {
        setTimeout(function () {
          var points = wrapper.querySelectorAll('.convenience__point');
    ...
    value: function check() {
      _superPropGet(GraphTabsWithPagination, "check", this, 3)([]);
    }
  }, {
    key: "events",
    value: function events() {
      var _this2 = this;
      _superPropGet(GraphTabsWithPagination, "events", this, 3)([]);
      this.prevBtn.addEventListener('click', function () {
        return _this2.showPreviousTab();
      });
      this.nextBtn.addEventListener('click', function () {
        return _this2.showNextTab();
      });
    }
  }, {
    key: "showPreviousTab",
    value: function showPreviousTab() {
    ...
    value: function updateCounter() {
      var currentTab = this.currentIndex ? this.currentIndex + 1 : 0 + 1;
      this.counterTabCurrent.textContent = currentTab > 9 ? currentTab : "0".concat(currentTab);
      this.counterTabTotal.textContent = this.tabsBtns.length > 9 ? "/ ".concat(this.tabsBtns.length) : "/ 0".concat(this.tabsBtns.length);
    }
  }, {
    key: "updatePoints",
    value: function updatePoints() {
      var _this3 = this;
      this.wrappersPoints.forEach(function (container) {
        var points = container.querySelectorAll('.convenience__point');
        console.log(points);
        points.forEach(function (point, index) {
          index === _this3.currentIndex ? point.classList.add('convenience__point--active') : point.classList.remove('convenience__point--active');
        });
      });
    }
  }, {
    ...
    value: function switchTabs(newTab) {
      _superPropGet(GraphTabsWithPagination, "switchTabs", this, 3)([newTab]);
...
}(graph_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modals_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_modals.js */ "./src/js/libs/_modals.js");
/* harmony import */ var _inputmask_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_inputmask.js */ "./src/js/libs/_inputmask.js");
...
/***/ "./src/js/project/_blog-images.js":
/*!****************************************!*\
  !*** ./src/js/project/_blog-images.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   changeBlogImages: () => (/* binding */ changeBlogImages)
/* harmony export */ });
/* harmony import */ var _utils_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/index.js */ "./src/js/utils/index.js");

var changeBlogImages = function changeBlogImages() {
  if (document.querySelector('[data-blog-images]')) {
    var blocks = document.querySelectorAll('[data-blog-images]');
    blocks === null || blocks === void 0 || blocks.forEach(function (block) {
      var name = block.getAttribute('data-blog-images');
      var cards = block.querySelectorAll('.blog-card__link');
      var images = block.querySelectorAll('.blog-block__image');
      if (cards.length !== images.length) {
        return new Error('the number of cards and images does not match');
      }
      images.forEach(function (image, index) {
        image.setAttribute('aria-labelledby', "".concat(name, "-").concat(index));
      ...
      cards.forEach(function (card, index) {
        card.setAttribute('id', "".concat(name, "-").concat(index));
        var showImage = function showImage(event) {
          var oldSelectedCard = block.querySelector('[aria-selected]');
  ...
  if (document.querySelector('.blog-card__link')) {
    var cards = document.querySelectorAll('.blog-card__link');
    var checkWidth = function checkWidth() {
      var width = (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__.getWindowWidth)();
      if (width < 993) {
    ...
    var checkWidthWrapper = (0,_utils_index_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(checkWidth);
...
/***/ "./src/js/project/_convenience.js":
/*!****************************************!*\
  !*** ./src/js/project/_convenience.js ***!
  \****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   arrangeConveniencePoints: () => (/* binding */ arrangeConveniencePoints),
/* harmony export */   createConveniencePoints: () => (/* binding */ createConveniencePoints)
/* harmony export */ });
/* harmony import */ var _utils_throttle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/_throttle.js */ "./src/js/utils/_throttle.js");

var createConveniencePoints = function createConveniencePoints() {
  if (document.querySelector('[data-tabs="convenience-block"]')) {
    var tabs = document.querySelector('[data-tabs="convenience-block"]');
    ...
    panels.forEach(function (panel) {
      var pointsWrapper = panel.querySelector('.convenience__points');
...
var arrangeConveniencePoints = function arrangeConveniencePoints() {
  var containers = document.querySelectorAll('.convenience__points');
  var updateCirclesPosition = function updateCirclesPosition() {
    containers.forEach(function (container) {
      var circles = container.querySelectorAll('.convenience__point');
      var radius = containers[0].offsetWidth / 2;
      var rotation = 360 / circles.length;
      circles.forEach(function (circle, i) {
        var position = "rotate(".concat(i * rotation, "deg) translate(").concat(radius, "px) rotate(-").concat(i * rotation, "deg)");
  ...
  if (containers.length > 0 && containers[0].querySelector('.convenience__point')) {
    ...
    var throttledUpdate = (0,_utils_throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(updateCirclesPosition);
...
/***/ "./src/js/project/_fixed-header.js":
/*!*****************************************!*\
  !*** ./src/js/project/_fixed-header.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var fixedHeader = function fixedHeader() {
  ...
  if (hero && header) {
    ...
    changeClasses();
    var changeClassesTrottle = (0,_utils_throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(changeClasses);
...
/***/ "./src/js/project/_product-card-tooltip.js":
/*!*************************************************!*\
  !*** ./src/js/project/_product-card-tooltip.js ***!
  \*************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   showTooltipInProductCard: () => (/* binding */ showTooltipInProductCard)
/* harmony export */ });
...
var showTooltipInProductCard = function showTooltipInProductCard() {
  var productCards = document.querySelectorAll('.product-card');
  var tippyElements = [];
  productCards.forEach(function (productCard) {
    tippyElements.push.apply(tippyElements, _toConsumableArray(productCard.querySelectorAll('[data-tippy-content]')));
  });
  (0,tippy_js__WEBPACK_IMPORTED_MODULE_0__["default"])(tippyElements, {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   changeColorSideMenu: () => (/* binding */ changeColorSideMenu)
/* harmony export */ });
/* harmony import */ var _utils_throttle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/_throttle.js */ "./src/js/utils/_throttle.js");

var changeColorSideMenu = function changeColorSideMenu() {
  var sideMenu = document.querySelector('.side-menu');
  var hero = document.querySelector('.hero-home');
  if (sideMenu && hero) {
    var blocks = sideMenu.querySelectorAll('[data-color]');
    var heroHeight = hero.offsetHeight;
    var changeClasses = function changeClasses() {
      if (blocks.length) {
        var scrollDistance = window.scrollY;
        blocks.forEach(function (block) {
          var topPosition = block.offsetTop;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sliders_hero_home_slider_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sliders/_hero-home-slider.js */ "./src/js/project/sliders/_hero-home-slider.js");
/* harmony import */ var _sliders_reviews_slider_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sliders/_reviews-slider.js */ "./src/js/project/sliders/_reviews-slider.js");
/* harmony import */ var _sliders_video_reviews_slider_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sliders/_video-reviews-slider.js */ "./src/js/project/sliders/_video-reviews-slider.js");
/* harmony import */ var _sliders_completed_projects_sliders_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./sliders/_completed-projects-sliders.js */ "./src/js/project/sliders/_completed-projects-sliders.js");
/* harmony import */ var _sliders_blog_slider_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sliders/_blog-slider.js */ "./src/js/project/sliders/_blog-slider.js");
/* harmony import */ var _fixed_header_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./_fixed-header.js */ "./src/js/project/_fixed-header.js");
/* harmony import */ var _side_menu_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./_side-menu.js */ "./src/js/project/_side-menu.js");
/* harmony import */ var _product_card_tooltip_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./_product-card-tooltip.js */ "./src/js/project/_product-card-tooltip.js");
/* harmony import */ var _blog_images_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./_blog-images.js */ "./src/js/project/_blog-images.js");
/* harmony import */ var _convenience_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./_convenience.js */ "./src/js/project/_convenience.js");
...
(0,_fixed_header_js__WEBPACK_IMPORTED_MODULE_5__.fixedHeader)();
(0,_side_menu_js__WEBPACK_IMPORTED_MODULE_6__.changeColorSideMenu)();
(0,_product_card_tooltip_js__WEBPACK_IMPORTED_MODULE_7__.showTooltipInProductCard)();
(0,_blog_images_js__WEBPACK_IMPORTED_MODULE_8__.changeBlogImages)();
(0,_convenience_js__WEBPACK_IMPORTED_MODULE_9__.createConveniencePoints)();
(0,_convenience_js__WEBPACK_IMPORTED_MODULE_9__.arrangeConveniencePoints)();

/***/ }),

/***/ "./src/js/project/sliders/_blog-slider.js":
/*!************************************************!*\
  !*** ./src/js/project/sliders/_blog-slider.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.blog-block__swiper')) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.blog-block__swiper', {
    loop: true,
    speed: 800,
    navigation: {
...
/***/ "./src/js/project/sliders/_completed-projects-sliders.js":
/*!***************************************************************!*\
  !*** ./src/js/project/sliders/_completed-projects-sliders.js ***!
  \***************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.completed-projects__swiper')) {
  var allSwipers = document.querySelectorAll('.completed-projects__swiper');
...
/***/ "./src/js/project/sliders/_hero-home-slider.js":
/*!*****************************************************!*\
  !*** ./src/js/project/sliders/_hero-home-slider.js ***!
  \*****************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.hero-home__swiper')) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.hero-home__swiper', {
    loop: true,
    speed: 800,
    slidesPerGroup: 1,
    slidesPerView: 1,
...
/***/ "./src/js/project/sliders/_reviews-slider.js":
/*!***************************************************!*\
  !*** ./src/js/project/sliders/_reviews-slider.js ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.reviews__swiper')) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__swiper', {
    loop: true,
    speed: 800,
    spaceBetween: 15,
    navigation: {
...
/***/ "./src/js/project/sliders/_video-reviews-slider.js":
/*!*********************************************************!*\
  !*** ./src/js/project/sliders/_video-reviews-slider.js ***!
  \*********************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.video-reviews__swiper')) {
  new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.video-reviews__swiper', {
    loop: true,
    speed: 800,
    spaceBetween: 10,
    slidesPerGroup: 1,
...
var burger = function burger() {
  ...
  var burgerButtonText = document.querySelector('[data-burger-button-text]');
  ...
  if (spollersArray.length > 0) {
    ...
    var initSpollerButton = function initSpollerButton(spollersBlock) {
      ...
      if (spollerButtons.length) {
        ...
        spollerButtons.forEach(function (spollerButton) {
          if (hideSpollerBody) {
    ...
    var mdQueriesArray = (0,_utils_data_media_queries_js__WEBPACK_IMPORTED_MODULE_1__.dataMediaQueries)(spollersArray, 'spollers');
...
/***/ "./src/js/utils/_get-window-width.js":
/*!*******************************************!*\
  !*** ./src/js/utils/_get-window-width.js ***!
  \*******************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getWindowWidth: () => (/* reexport safe */ _get_window_width_js__WEBPACK_IMPORTED_MODULE_1__.getWindowWidth),
/* harmony export */   throttle: () => (/* reexport safe */ _throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)
/* harmony export */ });
/* harmony import */ var _throttle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./_throttle.js */ "./src/js/utils/_throttle.js");
/* harmony import */ var _get_window_width_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./_get-window-width.js */ "./src/js/utils/_get-window-width.js");
...
/* harmony import */ var _project_index_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./project/index.js */ "./src/js/project/index.js");
